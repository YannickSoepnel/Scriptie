(function(g, e) {
    var f = {
        extend: function(a, c) {
            for (var h in c)
                -1 !== "browser cpu device engine os".indexOf(h) && 0 === c[h].length % 2 && (a[h] = c[h].concat(a[h]));
            return a
        },
        has: function(a, c) {
        ...
        for (var a, c = 0, h, b, d, k, g, f, p = arguments; c < p.length && !g; ) {
            ...
            if ("undefined" === typeof a)
                ...
                n)
                    ...
                    "object" === typeof k ? a[k[0]] = e : a[k] = e);
            for (h = b = 0; h < q.length && !g; )
                if (g = q[h++].exec(this.getUA()))
                    for (d = 0; d < n.length; d++)
                        f = g[++b],
                        k = n[d],
                        "object" === typeof k && 0 < k.length ? 2 == k.length ? a[k[0]] = "function" == typeof k[1] ? k[1].call(this, f) : k[1] : 3 == k.length ? a[k[0]] = "function" !== typeof k[1] || k[1].exec && k[1].test ? f ? f.replace(k[1], k[2]) : e : f ? k[1].call(this, f, k[2]) : e : 4 == k.length && (a[k[0]] = f ? k[3].call(this, f.replace(k[1], k[2])) : e) : a[k] = f ? f : e;
            c += 2
        }
        return a
    }
      , b = function(a, c) {
        for (var h in c)
            if ("object" === typeof c[h] && 0 < c[h].length)
    ...
    "undefined" !== typeof exports ? ("undefined" !== typeof module && module.exports && (exports = module.exports = q),
    exports.UAParser = q) : "function" === typeof define && define.amd ? define(function() {
        return q
    }) : g.UAParser = q;
...
var Detector = function() {
    ...
    var n = {}, b = {}, d;
    for (d in g)
        f.style.fontFamily = g[d],
        e.appendChild(f),
        n[g[d]] = f.offsetWidth,
        b[g[d]] = f.offsetHeight,
        e.removeChild(f);
...
var swfobject = function() {
    ...
    function f(a) {
        if (typeof w.addEventListener != u)
            w.addEventListener("load", a, !1);
        else if (typeof m.addEventListener != u)
        ...
        if (0 < a)
            for (var c = 0; c < a; c++) {
                ...
                if (0 < l.pv[0]) {
                    ...
                    if (k)
                        if (!D(z[c].swfVersion) || l.wk && 312 > l.wk)
                            if (z[c].expressInstall && p()) {
                                ...
                                for (var g = {}, k = k.getElementsByTagName("param"), m = k.length, t = 0; t < m; t++)
                                    "movie" != k[t].getAttribute("name").toLowerCase() && (g[k[t].getAttribute("name")] = k[t].getAttribute("value"));
                                q(f, g, b, e)
                            } else
                                r(k),
                                e && e(f);
                    ...
                    B(b, !0),
                    e && ((b = d(b)) && typeof b.SetVariable != u && (f.success = !0,
                    f.ref = b),
                    e(f))
            }
    }
    ...
    function q(c, b, d, e) {
        ...
        var f = h(d);
        if (f) {
            "OBJECT" == f.nodeName ? (F = v(f),
            J = null) : (F = f,
            J = d);
            c.id = P;
            if (typeof c.width == u || !/%$/.test(c.width) && 310 > parseInt(c.width, 10))
                c.width = "310";
            if (typeof c.height == u || !/%$/.test(c.height) && 137 > parseInt(c.height, 10))
                c.height = "137";
            ...
            l.ie && l.win && 4 != f.readyState && (e = m.createElement("div"),
            d += "SWFObjectNew",
            e.setAttribute("id", d),
        ...
        if (l.win && l.ie)
            ...
            if (a = a.childNodes)
                for (var b = a.length, h = 0; h < b; h++)
                    1 == a[h].nodeType && "PARAM" == a[h].nodeName || 8 == a[h].nodeType || c.appendChild(a[h].cloneNode(!0));
        return c
    }
    function a(a, c, b) {
        var d, e = h(b);
        if (l.wk && 312 > l.wk)
            return d;
        if (e)
            if (typeof a.id == u && (a.id = b),
            l.ie && l.win) {
                var f = "", k;
                for (k in a)
                    a[k] != Object.prototype[k] && ("data" == k.toLowerCase() ? c.movie = a[k] : "styleclass" == k.toLowerCase() ? f += ' class="' + a[k] + '"' : "classid" != k.toLowerCase() && (f += " " + k + '="' + a[k] + '"'));
                k = "";
                for (var g in c)
                    c[g] != Object.prototype[g] && (k += '<param name="' + g + '" value="' + c[g] + '" />');
                ...
                for (var t in a)
                    a[t] != Object.prototype[t] && ("styleclass" == t.toLowerCase() ? g.setAttribute("class", a[t]) : "classid" != t.toLowerCase() && g.setAttribute(t, a[t]));
                for (f in c)
                    c[f] != Object.prototype[f] && "movie" != f.toLowerCase() && (a = g,
                    k = f,
                    t = c[f],
                    b = m.createElement("param"),
    ...
    function c(a) {
        var c = h(a);
        c && "OBJECT" == c.nodeName && (l.ie && l.win ? (c.style.display = "none",
        function() {
            if (4 == c.readyState) {
                var b = h(a);
                if (b) {
    ...
    function k(a, c, b, h) {
        if (!l.ie || !l.mac) {
            ...
            d && (b = b && "string" == typeof b ? b : "screen",
            h && (M = y = null),
            y && M == b || (h = m.createElement("style"),
            h.setAttribute("type", "text/css"),
            h.setAttribute("media", b),
            y = d.appendChild(h),
            l.ie && l.win && typeof m.styleSheets != u && 0 < m.styleSheets.length && (y = m.styleSheets[m.styleSheets.length - 1]),
            M = b),
            l.ie && l.win ? y && typeof y.addRule == x && y.addRule(a, c) : y && typeof m.createTextNode != u && y.appendChild(m.createTextNode(a + " {" + c + "}")))
        }
    }
    function B(a, c) {
        if (Q) {
    ...
    var u = "undefined", x = "object", G = "application/x-shockwave-flash", P = "SWFObjectExprInst", w = window, m = document, A = navigator, R = !1, H = [function() {
        R ? n() : b()
    }
    ], z = [], K = [], E = [], F, J, L, O, C = !1, I = !1, y, M, Q = !0, l = function() {
        var a = typeof m.getElementById != u && typeof m.getElementsByTagName != u && typeof m.createElement != u
          ...
          , f = [0, 0, 0]
          , e = null;
        if (typeof A.plugins != u && typeof A.plugins["Shockwave Flash"] == x)
            !(e = A.plugins["Shockwave Flash"].description) || typeof A.mimeTypes != u && A.mimeTypes[G] && !A.mimeTypes[G].enabledPlugin || (R = !0,
            d = !1,
            e = e.replace(/^.*\s+(\S+\s+\S+$)/, "$1"),
            f[0] = parseInt(e.replace(/^(.*)\..*$/, "$1"), 10),
            f[1] = parseInt(e.replace(/^.*\.(.*)\s.*$/, "$1"), 10),
            f[2] = /[a-zA-Z]/.test(e) ? parseInt(e.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
        else if (typeof w.ActiveXObject != u)
            try {
                var k = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
                k && (e = k.GetVariable("$version")) && (d = !0,
                e = e.split(" ")[1].split(","),
    ...
    (function() {
        l.w3 && ((typeof m.readyState != u && "complete" == m.readyState || typeof m.readyState == u && (m.getElementsByTagName("body")[0] || m.body)) && g(),
        C || (typeof m.addEventListener != u && m.addEventListener("DOMContentLoaded", g, !1),
        l.ie && l.win && (m.attachEvent("onreadystatechange", function() {
    ...
    return {
        ...
        embedSWF: function(c, b, h, d, f, k, g, t, m, n) {
            ...
            l.w3 && !(l.wk && 312 > l.wk) && c && b && h && d && f ? (B(b, !1),
            e(function() {
                h += "";
                d += "";
                var e = {};
                ...
                if (g && typeof g === x)
                    for (var w in g)
                        l.flashvars = typeof l.flashvars != u ? l.flashvars + ("&" + w + "=" + g[w]) : w + "=" + g[w];
                if (D(f))
                    v = a(e, l, b),
                    e.id == b && B(b, !0),
                    r.success = !0,
            ...
            if (c) {
                ...
                for (var c = c.split("&"), b = 0; b < c.length; b++)
                    if (c[b].substring(0, c[b].indexOf("=")) == a)
                        return N(c[b].substring(c[b].indexOf("=") + 1))
            }
            return ""
        },
        expressInstallCallback: function() {
            if (I) {
                var a = h(P);
                a && F && (a.parentNode.replaceChild(F, a),
                J && (B(J, !0),
                l.ie && l.win && (F.style.display = "block")),
                L && L(O));
                I = !1
            }
        }
...
function murmurhash3_32_gc(g, e) {
    ...
    b = e;
    for (p = 0; p < n; )
        d = g.charCodeAt(p) & 255 | (g.charCodeAt(++p) & 255) << 8 | (g.charCodeAt(++p) & 255) << 16 | (g.charCodeAt(++p) & 255) << 24,
        ++p,
    ...
    switch (f) {
    case 3:
        d ^= (g.charCodeAt(p + 2) & 255) << 16;
    case 2:
        d ^= (g.charCodeAt(p + 1) & 255) << 8;
    case 1:
        d ^= g.charCodeAt(p) & 255,
        d = 3432918353 * (d & 65535) + ((3432918353 * (d >>> 16) & 65535) << 16) & 4294967295,
        d = d << 15 | d >>> 17,
        b ^= 461845907 * (d & 65535) + ((461845907 * (d >>> 16) & 65535) << 16) & 4294967295
    }
    b ^= g.length;
    b ^= b >>> 16;
...
;var deployJava = function() {
    ...
    var n = "codebase code name archive object width height alt align hspace vspace".split(" ").concat(f), b;
    try {
    ...
    var p = {
        ...
        getJREs: function() {
            ...
            if (this.isPluginInstalled())
                for (var c = this.getPlugin().jvms, b = 0; b < c.getLength(); b++)
                    a[b] = c.get(b).version;
            else
                c = this.getBrowser(),
                "MSIE" == c ? this.testUsingActiveX("1.7.0") ? a[0] = "1.7.0" : this.testUsingActiveX("1.6.0") ? a[0] = "1.6.0" : this.testUsingActiveX("1.5.0") ? a[0] = "1.5.0" : this.testUsingActiveX("1.4.2") ? a[0] = "1.4.2" : this.testForMSVM() && (a[0] = "1.1") : "Netscape Family" == c && (this.getJPIVersionUsingMimeType(),
            ...
            if (this.debug)
                for (b = 0; b < a.length; ++b)
                    g("[getJREs()] We claim to have detected Java SE " + a[b]);
            return a
        },
        installJRE: function(a, c) {
            if (this.isPluginInstalled() && this.isAutoInstallEnabled(a)) {
                var b = !1;
                if (b = this.isCallbackSupported() ? this.getPlugin().installJRE(a, c) : this.getPlugin().installJRE(a))
                    this.refresh(),
        ...
        installLatestJRE: function(a) {
            if (this.isPluginInstalled() && this.isAutoInstallEnabled()) {
                var c = !1;
                if (c = this.isCallbackSupported() ? this.getPlugin().installLatestJRE(a) : this.getPlugin().installLatestJRE())
                    this.refresh(),
                    null != this.returnPage && (document.location = this.returnPage);
                return c
            }
            ...
            if ("true" == this.EAInstallEnabled && -1 != c.indexOf("win") && null != this.EarlyAccessURL)
                ...
                if ("Netscape Family" == a && -1 != c.indexOf("win32"))
        ...
        runApplet: function(a, c, b) {
            ...
            null != d ? "?" != this.getBrowser() ? this.versionCheck(b + "+") ? this.writeAppletTag(a, c) : this.installJRE(b + "+") && (this.refresh(),
            location.href = document.location,
            this.writeAppletTag(a, c)) : this.writeAppletTag(a, c) : g("[runApplet()] Invalid minimumVersion argument to runApplet():" + b)
        },
        writeAppletTag: function(a, c) {
            ...
            f = !1;
            for (var r in c) {
                "codebase_lookup" == r && (f = !0);
                if ("object" == r || "java_object" == r || "java_code" == r)
                    e = !1;
        ...
        versionCheck: function(a) {
            var c = 0
              , b = a.match("^(\\d+)(?:\\.(\\d+)(?:\\.(\\d+)(?:_(\\d+))?)?)?(\\*|\\+)?$");
            if (null != b) {
                for (var d = a = !1, e = [], f = 1; f < b.length; ++f)
                    "string" == typeof b[f] && "" != b[f] && (e[c] = b[f],
                    c++);
                "+" == e[e.length - 1] ? (d = !0,
                a = !1,
                e.length--) : "*" == e[e.length - 1] ? (d = !1,
                a = !0,
                e.length--) : 4 > e.length && (d = !1,
                a = !0);
                c = this.getJREs();
                for (f = 0; f < c.length; ++f)
                    if (this.compareVersionToPattern(c[f], e, a, d))
                        return !0
            } else
                c = "Invalid versionPattern passed to versionCheck: " + a,
                g("[versionCheck()] " + c),
                alert(c);
            return !1
        },
        isWebStartInstalled: function(a) {
            ...
            if ("undefined" == a || null == a)
                a = "1.4.2";
            var c = !1;
            null != a.match("^(\\d+)(?:\\.(\\d+)(?:\\.(\\d+)(?:_(\\d+))?)?)?$") ? c = this.versionCheck(a + "+") : (g("[isWebStartInstaller()] Invalid minimumVersion argument to isWebStartInstalled(): " + a),
            c = this.versionCheck("1.4.2+"));
            return c
        },
        getJPIVersionUsingMimeType: function() {
            for (var a = 0; a < navigator.mimeTypes.length; ++a) {
                ...
                if (null != c && (this.firefoxJavaVersion = c[1],
        ...
        launchWebStartApplication: function(a) {
            ...
            if (!1 == this.isWebStartInstalled("1.7.0") && (!1 == this.installJRE("1.7.0+") || !1 == this.isWebStartInstalled("1.7.0")))
                return !1;
            var c = null;
            ...
            document.location = c) : (a = document.createElement("div"),
            a.id = "div1",
        ...
        getBrowser: function() {
            if (null == this.browserName) {
                ...
                g("[getBrowser()] navigator.userAgent.toLowerCase() -> " + a);
        ...
        testUsingActiveX: function(a) {
            ...
            if ("undefined" == typeof ActiveXObject || !ActiveXObject)
                return g("[testUsingActiveX()] Browser claims to be IE, but no ActiveXObject object?"),
                !1;
            try {
        ...
        testUsingMimeTypes: function(a) {
            if (!navigator.mimeTypes)
                return g("[testUsingMimeTypes()] Browser claims to be Netscape family, but no mimeTypes[] array?"),
                !1;
            for (var c = 0; c < navigator.mimeTypes.length; ++c) {
                ...
                if (null != b && this.compareVersions(b[1], a))
                    return !0
            }
            return !1
        },
        testUsingPluginsArray: function(a) {
            ...
            for (var c = navigator.platform.toLowerCase(), b = 0; b < navigator.plugins.length; ++b)
                if (s = navigator.plugins[b].description,
                -1 != s.search(/^Java Switchable Plug-in (Cocoa)/)) {
                    if (this.compareVersions("1.5.0", a))
                        return !0
                } else if (-1 != s.search(/^Java/) && -1 != c.indexOf("win") && (this.compareVersions("1.5.0", a) || this.compareVersions("1.6.0", a)))
                    return !0;
        ...
        compareVersions: function(a, c) {
            for (var b = a.split("."), d = c.split("."), e = 0; e < b.length; ++e)
                b[e] = Number(b[e]);
...
(function(g) {
    ...
    n.prototype = {
        ...
        getFingerprint: function() {
            ...
            return murmurhash3_32_gc(b + "|" + d + "|" + f + "|" + g + "|" + n + "|" + v + "|" + a + "|" + c + "|" + h + "|" + t + "|" + D, 256)
        },
        ...
        isIphone: function() {
            return e.ua.match(/iPhone/i) ? !0 : !1
        },
        isIpad: function() {
        ...
        getPlugins: function() {
            for (var b = "", d = 0; d < navigator.plugins.length; d++)
                b = d == navigator.plugins.length - 1 ? b + navigator.plugins[d].name : b + (navigator.plugins[d].name + ", ");
            return b
        },
        isJava: function() {
        ...
        getMimeTypes: function() {
            for (var b = "", d = 0; d < navigator.mimeTypes.length; d++)
                b = d == navigator.mimeTypes.length - 1 ? b + navigator.mimeTypes[d].description : b + (navigator.mimeTypes[d].description + ", ");
            return b
        },
        isFont: function(b) {
            return f.detect(b)
